...
export class QuotesComponent implements OnInit {
  ...
  quotes: Quotes [] = [
    ...
    new Quotes (5, 'Caleb Langat','Cabernet Sauvignon','This is the most loved and popular red wine brand in the world. Cabernet Sauvignon grape comes from a cross between Cabernet Franc and Sauvignon Blanc grapes developed naturally. Its origin is Bordeaux in France. It has a characteristic of high concentration, rich flavor, high tannin content, and unhurriedly aged, which in tandem bring out the elegance in both the taste and aromas. ')
  ];

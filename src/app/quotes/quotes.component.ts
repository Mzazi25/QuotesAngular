...
export class QuotesComponent implements OnInit {
  ...
  quotes: Quotes [] = [
    ...
    new Quotes (2,'Turkey', 'Mzazi','SYRAH', ' Syrah (aka Shiraz) is a full-bodied red wine thats heavily planted in the Rhône Valley in France and Australia. The wines have intense fruit flavors and medium-weight tannins. Syrah is commonly blended with Grenache and Mourvèdre to create the red Rhône blend. The wine often has a meaty (beef broth, jerky) quality.',new Date(2020,3,14)),
    new Quotes (3,'Egypt', 'Langat','ZINFANDEL', ' Zinfandel (aka Primitivo) is a medium-bodied red wine that originated in Croatia. Wines are fruit-forward and spicy with a medium length finish. Zinfandel is a red grape that may be better known in its pink variation, White Zinfandel.',new Date(2020,3,14)),
    new Quotes (4,'Barbados', 'Kevin','CHARDONNAY', 'Chardonnay is a dry full-bodied white wine that was planted in large quantities for the first time in France. When oak-aged, Chardonnay will have spicy, bourbon-y notes. Unoaked wines are lighter and zesty with apple and citrus flavors. Chardonnay is the white grape of Burgundy.',new Date(2020,3,14)),
